...
import { gamePersuadeRouter } from './routes/gamePersuade.js';
import { gameDramaRouter } from './routes/gameDrama.js';
import { memoryRouter } from './routes/memory.js';
import { diaryRouter } from './routes/diary.js';
import { agentMemoryPanelRouter } from './routes/agentMemoryPanel.js';
...
app.route('/api/game', gamePersuadeRouter);
app.route('/api/game/drama', gameDramaRouter);
app.route('/api/memory', memoryRouter);
app.route('/api/diary', diaryRouter);
app.use('/api/agent-memory/*', requireAuth);
