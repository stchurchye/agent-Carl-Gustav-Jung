    ...
    meet: {
      ...
      steps: [
        { kind: 'line', who: 'jinyu', text: '哟,这就是新来的雪团?瞧这怯生生的样子,也敢来争宠?当众说句话听听。' },
        {
          ...
          options: [
            { label: '贵妃言重了。雪团初入宫闱,只求安分,不敢与娘娘争一时长短。', good: true },
            { label: '求贵妃开恩,雪团再不敢往前凑了……', good: false, reply: '这般没骨头,也配进这后宫?' },
            { label: '贵妃凭什么这样说我?', good: false, reply: '牙尖嘴利。我倒要看你横到几时。' },
          ],
          onPass: 'favor',
          onFail: 'snub',
        },
      ...
      steps: [
        {
          ...
          options: [
            { label: '娘娘口口声声规矩。只是当年那段出身,怕也不大经得起人提吧?', good: true },
            { label: '娘娘说的是,雪团知错了。', good: false, reply: '知错?那就乖乖认下失仪之罪。' },
            { label: '你不就是个出身低贱的!', good: false, reply: '(脸色一沉)当殿辱骂贵妃,反坐实了你的失仪。' },
          ],
          onPass: 'triumph',
          onFail: 'downfall',
        },
      ...
      steps: [
        {
          ...
          options: [
            { label: '臣妾乍受冤屈,情急失了态,确有不当。可若蒙了冤都不许辩一句——臣妾失的是仪,娘娘要的,怕不止这桩仪。', good: true },
            { label: '臣妾失仪,任凭娘娘责罚。', good: false, reply: '既认了,就别怪本宫不留情面。' },
            { label: '我没失仪,是你血口喷人!', good: false, reply: '当殿撒泼——这失仪之罪,你自己认下了。' },
          ],
          onPass: 'triumph',
          onFail: 'downfall',
        },
    ...
    court: {
      ...
      steps: [
        ...
        { kind: 'line', who: 'quanhuang', text: '(声音不高,殿中却落针可闻)雪团,抬起头。朕这一问,问的不是辞藻——是你这颗心,配不配站在这儿。' },
        {
          ...
          options: [
            { label: '臣妾初见天颜,本该惶恐。可站在这满殿珠翠里,臣妾倒想起阶下那丛野菊——不争春芳,自有秋香。', good: true },
            { label: '陛下天威盖世,臣妾愿为陛下肝脑涂地!', good: false, reply: '(淡淡移开目光)满嘴谀词,朕听腻了。' },
            { label: '臣妾以为,这中宫之位,非臣妾莫属。', good: false, reply: '初次面圣便如此狂言,目无尊卑。' },
          ],
          onPass: 'scheme',
          onFail: 'favorLost',
        },
      ...
      steps: [
        {
          ...
          options: [
            { label: '臣妾这身微末出身,正如这中秋的月——不必谁来点燃,自己就亮给满天看。', good: true },
            { label: '月亮又圆又亮,愿陛下福寿绵长。', good: false, reply: '这等粗鄙颂词,也敢称诗?' },
            { label: '臣妾不善诗文,不敢献丑……', good: false, reply: '(金羽掩唇)果然是上不得台面的。' },
          ],
          onPass: 'talentWin',
          onFail: 'duelLost',
        },
      ...
      steps: [
        {
          ...
          options: [
            { label: '月色清贵,臣妾不敢争辉,只愿做云一缕,衬得这轮月、这满殿,更亮些。', good: true },
            { label: '臣妾的诗,定要压贵妃一头!', good: false, reply: '藏锋的局,你倒先露了争心。' },
            { label: '臣妾才疏,实在作不出。', good: false, reply: '连一句都没有,谈何贤德?' },
          ],
          onPass: 'virtueWin',
          onFail: 'duelLost',
        },
    ...
    tp_fail: {
      ...
      steps: [
        { kind: 'line', who: 'xuetuan', text: '(药方递出去的刹那,心猛地一沉——那一对,我标反了!汤已端向太后)' },
        {
          ...
          options: [
            { label: '且慢——这方配伍,臣妾瞧着有一味相冲,恐非稳妥。请太医当场再验。太后凤体为重,宁慢勿错。', good: true },
            { label: '是臣妾标错了药,求太后恕罪!', good: false, reply: '亲口认下下错药,这罪你担得起?' },
            { label: '没错,这汤喝得!', good: false, reply: '一碗下去,太后若有闪失,你九族难保。' },
          ],
          onPass: 'tp_recover',
          onFail: 'tp_doom',
        },
    ...
    np_caught: {
      ...
      steps: [
        { kind: 'line', who: 'laofu', text: '(提灯而来,光照到她发抖的爪)三更半夜,妃主不在椒房安歇,在这偏殿外鬼鬼祟祟——做什么?' },
        {
          ...
          options: [
            { label: '嬷嬷莫惊。臣妾夜里睡不安稳,想着陛下近来劳神,起身想亲手煎盅安神汤,谁知走岔了路。', good: true },
            { label: '我……我什么都没做!', good: false, reply: '(提灯逼近)越是这样,越是有鬼。' },
            { label: '我乃妃位,你也敢拦?', good: false, reply: '妃位深夜潜伏禁地,这话可不好听。' },
          ],
          onPass: 'np_slip',
          onFail: 'np_doom',
        },
    ...
    expose: {
      ...
      steps: [
        { kind: 'line', who: 'xuetuan', text: '(攥着那截沾骨屑的衣料)真凶招了:那根扎针的啃骨,是这宫人奉金羽之命连夜刻好、塞进墨兰房中的。可金羽是贵妃,空口指认她,反成了我的"攀诬之罪"。' },
        {
          ...
          options: [
            { label: '陛下明鉴!这扎针的啃骨,是这奴才奉金羽之命连夜刻的——分明有人,要借一条人命,除臣妾的臂膀。', good: true },
            { label: '不是墨兰,一定是金羽干的!', good: false, reply: '空口攀诬贵妃,你又是一桩罪。' },
            { label: '求陛下饶了墨兰吧……', good: false, reply: '巫蛊大罪,岂是求情能免?' },
          ],
          onPass: 'act3win',
          onFail: 'silenced',
        },
    ...
    bx_expose: {
      ...
      steps: [
        { kind: 'line', who: 'xuetuan', text: '(攥着那包白霜)抓住了!碗里被掺了明矾——但凡掺了明矾,管它谁的血滴进去,都会相融!这一场滴血验亲,从头到尾,就是金羽做的局!' },
        {
          ...
          options: [
            { label: '陛下、太后请验这碗水——掺了明矾!但凡掺矾,谁的血滴进去都相融。这哪是验亲,是金羽做的局!', good: true },
            { label: '这血根本不是我的,验错了!', good: false, reply: '血明明相融,你还要狡辩?' },
            { label: '我不是罪臣之后,你们要信我啊!', good: false, reply: '空口无凭,谁信你?' },
          ],
          onPass: 'bx_win',
          onFail: 'bx_doom3',
        },
    ...
    finalShowStrong: {
      ...
      steps: [
        { kind: 'line', who: 'xuetuan', text: '密信在前,太后懿旨在后,党羽噤声。这最后一句,我只需把刀递实——金羽,已无路可退。' },
        {
          ...
          options: [
            { label: '铁证、太后懿旨俱在,臣妾不必多言——只请陛下看清:今日纵了金羽,寒的是天下忠良的心。', good: true },
            { label: '金羽,这下你输定了!', good: false, reply: '(犬皇皱眉)御前失态,得意忘形。' },
            { label: '臣妾还要再添十条她的罪状!', good: false, reply: '铁证已足,你这一急,反显心虚。' },
          ],
          onPass: 'a4vouch',
          onFail: 'a4carried',
        },
    ...
    finalShow: {
      ...
      steps: [
        { kind: 'line', who: 'xuetuan', text: '(将供词与药渣高举过顶)铁证在此!害皇嗣的不是别人,正是贵妃金羽,嫁祸于我,以绝立后之路!成败荣枯、这一年的血与泪,都压在我接下来这一句话上了。' },
        {
          ...
          options: [
            { label: '陛下!药渣供词字字指向贵妃。臣妾所求非为私怨,而为皇嗣、为国本——莫让构陷忠良之人,再立中宫!', good: true },
            { label: '反正就是她干的,陛下信我就对了!', good: false, reply: '空口一句,就想定贵妃死罪?' },
            { label: '臣妾……臣妾也不知该说什么了。', good: false, reply: '(满殿窃笑)连话都说不周全。' },
          ],
          onPass: 'a4vouch',
          onFail: 'yusui',
        },
