...
export const ACT1: Script = {
  ...
  scenes: {
    ...
    duelLost: {
      ...
      cast: ['jinyu', 'xuetuan'],
      steps: [
        { kind: 'line', who: 'jinyu', text: '(轻笑出声)江郎才尽了?方才那点伶牙俐齿,到了真章上,原来一句也凑不出。' },
        {
          kind: 'ending',
          outcome: 'bad',
    ...
    act3a: {
      ...
      goto: 'act3crisis',
      steps: [
        { kind: 'line', who: 'jinyu', text: '(一字一句,恨意森然)当殿点破本宫出身的那一天,本宫就发过誓——这笔账,要连本带利,从你最在乎的人身上讨回来。墨兰,不过是头一个。' },
      ],
    },
    act3b: {
      id: 'act3b',
    ...
    act3crisis: {
      ...
      cast: ['molan', 'xuetuan'],
      steps: [
        { kind: 'line', who: 'molan', text: '(声音抖得不成调)一个刻着陛下生辰八字的桐木小人……巫蛊厌胜,这是要诛九族的死罪啊!那东西不是我的,是有人塞进来的——可满宫谁信我?' },
        { kind: 'line', who: 'xuetuan', text: '(心一沉)金羽这一刀,捅的不是墨兰——是我。我若上前回护,便是同党,这一年挣的全得搭进去;我若撇清,墨兰今夜就得死。' },
        {
          ...
          options: [
            ...
            { label: '当殿割席、明哲保身,任她去——你还有更长的路', setFlags: ['cold_blood'], goto: 'forsake' },
          ],
        },
      ],
    },
    defend: {
      ...
      steps: [
        ...
        {
          kind: 'deduce',
          prompt: '近三日出入过墨兰寝殿的宫人都在此。嗅出谁的爪上沾着新刻桐木的木屑气、谁是金羽埋的钉子——揪出栽赃的真凶。',
          count: 7,
          budget: 2,
          seed: 13,
          onSolve: 'expose',
    ...
    expose: {
      ...
      steps: [
        { kind: 'line', who: 'xuetuan', text: '(攥着那截带木屑的衣料)真凶招了:桐木小人,是这宫人奉金羽之命新刻、连夜塞进墨兰房中的。可金羽是贵妃,空口指认她,反成了我的"攀诬之罪"。' },
        {
          kind: 'sayline',
          who: 'quanhuang',
    ...
    act3win: {
      ...
      steps: [
        ...
        { kind: 'line', who: 'molan', text: '(泪如雨下,死死攥住雪团的手)是你……是你拿命把我从鬼门关捞回来的。这条命,往后就是你的。' },
    ...
    forsake: {
      ...
      steps: [
        ...
        { kind: 'line', who: 'xuetuan', text: '(垂下眼,不敢看她)……拖下去吧。(在心里)对不起。这一年我爬得太高,高到再赔不起。我把唯一肯信我的人,亲手推进了火里。' },
      ...
      steps: [
        {
          kind: 'ending',
          outcome: 'bad',
          text: '【棠梨惊变 · 同戮】她查错了人,反被金羽倒咬一口:「妃位也敢替巫蛊之徒翻案,可见是一党!」铁证没找着,攀诬之罪倒坐实了。墨兰被拖出去的那一刻,回头冲她笑了笑——「不怪你。」三尺白绫,两条命。棠梨花落了满地,没人记得这宫里曾有过两个相互递过真心的人。',
        },
      ],
    },
    silenced: {
    ...
    act4: {
      ...
      steps: [
        ...
        { kind: 'line', who: 'jinyu', text: '(豁出去一般,厉声)陛下!立后是国本大事,岂容一个心怀叵测之人觊觎!臣妾要奏——她暗害皇嗣、私通宫外,桩桩是诛族的死罪!(这是金羽最后、也最毒的一击)' },
    ...
    a4Solo: {
      ...
      goto: 'a4threat',
      steps: [
        { kind: 'line', who: 'xuetuan', text: '满殿之上,竟无一人肯为我出列作证。当年那个能为我别过脸去落泪的人,已经被我亲手送走了。这最后一战,我注定孤身。' },
      ],
    },
    a4threat: {
      id: 'a4threat',
    ...
    a4Glory: {
      ...
      goto: 'a4probe',
      steps: [
        { kind: 'line', who: 'xuetuan', text: '(冷眼扫过殿中)当年御宴我锋芒太露,抢尽了风头,也把半个后宫推到了金羽那边。此刻她身后跟着乌泱泱一片附议的臣工——锋芒夺来的耀眼,如今都成了催命的债。' },
      ],
    },
    a4probe: {
      id: 'a4probe',
    ...
    mercyChoice: {
      ...
      cast: ['jinyu', 'xuetuan'],
      steps: [
        { kind: 'line', who: 'jinyu', text: '(瘫坐于地,凤冠歪斜,再无半分往日气焰)成王败寇……我栽了。要杀要剐,随你。' },
        { kind: 'line', who: 'xuetuan', text: '(俯视着她)这一刻我等了整整一年。踏过她,凤位就是我的。可踏下去的这一脚——是了结,还是开始?' },
        {
          kind: 'choice',
          prompt: '金羽伏地待决,凤位近在眼前。这最后一步,你怎么落?',
          options: [
            { label: '赶尽杀绝,要她偿命,踏着她登上凤位', goto: 'ruthlessBranch' },
            { label: '网开一面,依律论罪、不滥杀,留这一线生机', goto: 'mercyBranch' },
          ],
        },
      ],
    },
      ...
      steps: [
        {
          kind: 'ending',
          outcome: 'good',
          text: '【大结局 · 孤鸾正位】她依律论罪,没有滥杀,守住了为人的底线。凤印在手,六宫俯首。只是册后大典上,本该扶着她凤裾的那个位置,空着——棠梨宫那一夜,她亲手放走了唯一肯信她的人。坐上了最高处,身边却再没有一个能说真话的人。干净的胜利,孤独的凤座。〔全剧终 · 不负天下,独负一人〕',
        },
      ],
    },
    endBloodRobe: {
      ...
      steps: [
        {
          kind: 'ending',
          outcome: 'good',
          text: '【大结局 · 血染凤袍】一道赐死的旨意,金羽气绝于殿前。雪团踏着她的血,登上了凤位——再没有人敢与她为敌。可册后那日,连墨兰望她的眼神里,都多了一丝从前没有的怯。她终于成了这后宫最强的人,也成了当年最怕的那种人。凤袍加身,猩红刺目。〔全剧终 · 赢了天下,也染了手〕',
        },
      ],
    },
    endTyrant: {
      ...
      steps: [
        {
          kind: 'ending',
          outcome: 'bad',
          text: '【大结局 · 孤家寡人】她赐死了金羽,正如当年弃了墨兰——这一路,凡挡道的、凡牵绊的,她都亲手清干净了。凤位终于只剩她一个,空旷得能听见回声。夜深时她常想起入宫那年,那个会为一句真心而心软的雪团,早死在了通往这把椅子的路上。她赢得了一切,也只剩下一切——再没有一个人。〔全剧终 · 登顶之日,即孤绝之时〕',
        },
      ],
    },
    fengyun: {
      ...
      steps: [
        {
          kind: 'ending',
          outcome: 'bad',
          text: '【大结局 · 玉碎】铁证在手,话却没能说到犬皇心里去。金羽抓住那一丝破绽,反咬"伪造罪证、攀诬贵妃、其心可诛"。满殿风向倾覆,雪团百口莫辩。她到底没能跨过最后这道坎——玉碎宫倾,凤位易主。可她挺直脊背走向殿门时,没有低头:这一局,她输得起。〔败亡 · 功败垂成〕',
        },
      ],
    },
  },
