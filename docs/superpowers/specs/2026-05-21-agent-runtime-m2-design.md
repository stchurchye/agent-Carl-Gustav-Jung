...
- 日期：2026-05-21
- 状态：用户已确认 ✅ → writing-plans（15 件工具，OpenAlex+CrossRef，document_reader 三合一，~10-11 天）
...
| 2 | `search_papers` | **OpenAlex 主 + CrossRef 备**（两个都免费，学术 native） | 🔴 P0 |
...
| 9 | `get_paper_citations` | OpenAlex `/works/{id}/cited_by` | 🟡 P1 |
| 10 | `datetime_now` | 内置，无外部 API | 🟢 |
| 11 | `document_reader` | pdf-parse + mammoth + xlsx（dispatch by content-type）| 🟡 P1 |
